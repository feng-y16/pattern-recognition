...
offset=1
train_original_data=pd.read_csv("F:\\pythonhomework\\hw1\\E3E5_data\\train_data_E3E5_10genes.txt",sep=' ')
...
test_original_data=pd.read_csv("F:\\pythonhomework\\hw1\\E3E5_data\\test_data_E3E5_10genes.txt",sep=' ')
